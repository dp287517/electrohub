  ...
  const renderStep1_Describe = () => (
    <div className="animate-fade-in max-w-2xl mx-auto">
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-gray-800">Quel est le besoin ?</h2>
        <p className="text-gray-500">Décris ta tâche technique (ajout, suppression, modif...).</p>
      </div>
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {loading ? (
             <div className="h-80 flex flex-col items-center justify-center bg-white rounded-xl border border-dashed border-gray-300 text-gray-400 animate-pulse">
               ...
               <p className="text-xs mt-2">Lecture structure Excel + Vision SAP</p>
             </div>
            ...
            <div className="p-10 bg-yellow-50 border border-yellow-100 rounded-xl text-yellow-800 text-center">
               ...
               <p className="text-sm mt-1">Vérifie que le fichier sélectionné est bien un template DCF valide.</p>
            </div>
          )}
        </div>
